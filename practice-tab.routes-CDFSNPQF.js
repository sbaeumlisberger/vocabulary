...
var LongPressDirective = class _LongPressDirective {
  ...
  static {
    this.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({ type: _LongPressDirective, selectors: [["", "vtLongPress", ""]], outputs: { vtLongPress: "vtLongPress" }, standalone: true });
  }
};
...
var PracticeOverviewPageComponent = class _PracticeOverviewPageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PracticeOverviewPageComponent, selectors: [["vt-pratice-overview-page"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 28, vars: 8, consts: [[3, "translucent"], [3, "fullscreen"], ["collapse", "condense"], ["size", "large"], [1, "voc-content"], ["routerDirection", "forward", 3, "routerLink"]], template: function PracticeOverviewPageComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PracticeOverviewPageComponent, { className: "PracticeOverviewPageComponent", filePath: "src\\app\\components\\practice\\overview\\pratice-overview-page.component.ts", lineNumber: 32 });
})();
