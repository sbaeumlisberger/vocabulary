...
var TabsComponent = class _TabsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TabsComponent, selectors: [["vt-tabs"]], decls: 18, vars: 0, consts: [["slot", "bottom"], ["tab", "vocabulary"], ["name", "list-outline"], ["tab", "practice"], ["name", "school-outline"], ["tab", "statistics"], ["name", "stats-chart-outline"], ["tab", "settings"], ["name", "cog-outline"]], template: function TabsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TabsComponent, { className: "TabsComponent", filePath: "src/app/components/tabs/tabs.component.ts", lineNumber: 12 });
})();
...
var ROUTES = [
  ...
  },
  {
    ...
    children: [
      {
        path: "vocabulary",
        loadChildren: () => import("./vocabulary-tab.routes-6O555XKV.js").then((m) => m.ROUTES)
      },
      {
        path: "practice",
        loadChildren: () => import("./practice-tab.routes-SL2W5ADM.js").then((m) => m.ROUTES)
      },
      {
        path: "statistics",
        loadChildren: () => import("./statistics-tab.routes-XD42UN5A.js").then((m) => m.ROUTES)
      },
      {
        path: "settings",
        loadChildren: () => import("./settings-tab.routes-G2XPPZE5.js").then((m) => m.ROUTES)
      }
    ]
  }
];
...
//# sourceMappingURL=tabs-routes-X2J52QH5.js.map
