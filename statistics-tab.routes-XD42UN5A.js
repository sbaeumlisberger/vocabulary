...
var SatisticsOverviewPageComponent = class _SatisticsOverviewPageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SatisticsOverviewPageComponent, selectors: [["vt-statistics-overview-page"]], decls: 48, vars: 33, consts: [[3, "translucent"], [3, "fullscreen"], ["collapse", "condense"], ["size", "large"], [1, "voc-content", "ion-padding-start", "ion-padding-end"], [2, "font-weight", "bold"], [1, "level-button", 3, "click"], [1, "level-header"], ["icon", "rocket-outline"], [3, "value"], ["icon", "school-outline"], ["icon", "trending-up-outline"], ["icon", "checkmark-outline"], ["icon", "trophy-outline"]], template: function SatisticsOverviewPageComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SatisticsOverviewPageComponent, { className: "SatisticsOverviewPageComponent", filePath: "src/app/components/statistics/statistics-overview/statistics-overview-page.component.ts", lineNumber: 25 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LevelListComponent, { className: "LevelListComponent", filePath: "src/app/components/statistics/level-list/level-list.component.ts", lineNumber: 44 });
})();
...
//# sourceMappingURL=statistics-tab.routes-XD42UN5A.js.map
