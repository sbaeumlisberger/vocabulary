...
} from "./chunk-F5RWFUYL.js";
import "./chunk-GV3EGQ3X.js";
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddVocabularyComponent, { className: "AddVocabularyComponent", filePath: "src/app/components/vocabulary/add-vocabulary/add-vocabulary.component.ts", lineNumber: 41 });
})();
...
var VocabularyListPageComponent = class _VocabularyListPageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VocabularyListPageComponent, selectors: [["vt-vocabulary-list-page"]], decls: 20, vars: 3, consts: [[3, "translucent"], ["slot", "end"], [3, "click"], ["slot", "icon-only", "name", "add"], [3, "fullscreen"], ["collapse", "condense"], ["size", "large"], [1, "voc-content"], ["debounce", "200", 3, "ionInput"], ["threshold", "100px", 3, "ionInfinite", "disabled"], [2, "height", "8px"], ["loadingSpinner", "bubbles", "loadingText", "Loading more..."], ["slot", "start", "size", "small", 3, "name", "style"], ["side", "end"], ["color", "danger", 3, "click"], ["slot", "start", "name", "trash"], ["slot", "start", "size", "small", 3, "name"]], template: function VocabularyListPageComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VocabularyListPageComponent, { className: "VocabularyListPageComponent", filePath: "src/app/components/vocabulary/vocabulary-list/vocabulary-list-page.component.ts", lineNumber: 67 });
})();
...
//# sourceMappingURL=vocabulary-tab.routes-6O555XKV.js.map
